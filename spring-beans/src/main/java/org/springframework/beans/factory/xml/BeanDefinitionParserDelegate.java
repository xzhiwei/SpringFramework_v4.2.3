...
public class BeanDefinitionParserDelegate {
	 ...
	 * {@link org.springframework.beans.factory.parsing.ProblemReporter}.
	 */
	// 解析XML中每一个bean，生成一个BeanDefinitionHolder
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(
		...
		try {
			...
			// 这里是根据得到的类名，去实例化bean对象的地方，注意bean对象不等于BeanDefinition,bean对象只是使用简单的反射机制去得到的一个普通JAVA对象，
			// 而BeanDefinition还持有了许多定义信息，bean对象是BeanDefinition持有信息的一部分。
