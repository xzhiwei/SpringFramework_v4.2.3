 ...
 * 
 * 
 * NamedParameterJdbcTemplate提供了解析方法，把:name等数据解析成标准sql的？，形成可执行的sql，并做了缓存处理
 * 数据操作通过实现了JdbcOperations接口的JdbcTemplate类来实现
 * 
 */
public class NamedParameterJdbcTemplate implements NamedParameterJdbcOperations {
	...
	/**
	 * 创建一个固定大小的HashMap，记录访问顺序，Map大小大于缓存大小时，删除链表头
	 * 这个地方的处理方法可以学习
	 */
	 ...
	 * 
	 * 可以看到，操作数据库是通过JdbcOperations接口来操作的，具体实现是在JdbcTemplate类
	 * 
	 */
